...
def run_cv(cancer_type, feature_type, target, years=3, groups=("WHITE", "BLACK")):
    ...
    for i in range(20):
        seed = i
        df_m, _mixture_classifiers = run_mixture_cv(seed, dataset, groups=groups, **parametrs_mix)
        ...
        df_tl, _supervised_transfer_classifiers = run_supervised_transfer_cv(seed, dataset, groups=groups, **parametrs_tl)
