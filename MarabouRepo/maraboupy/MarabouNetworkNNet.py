...
from MarabouRepo.maraboupy.MarabouUtils import *
from MarabouRepo.maraboupy import MarabouCore
from MarabouRepo.maraboupy import MarabouNetwork
...
class MarabouNetworkNNet(MarabouNetwork.MarabouNetwork):
    ...
    def resetNetworkFromParameters(self, weights, biases, normalize = False,
