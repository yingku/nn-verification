...
class Equation:
    """Python class to conveniently represent :class:`~MarabouRepo.maraboupy.MarabouCore.Equation`
    ...
    Attributes:
        ...
        EquationType (:class:`~MarabouRepo.maraboupy.MarabouCore.EquationType`): Equation type (EQ, LE, GE)
    """
