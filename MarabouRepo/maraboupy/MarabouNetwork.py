...
from MarabouRepo.maraboupy import MarabouCore
from MarabouRepo.maraboupy import MarabouUtils
...
class MarabouNetwork:
    ...
    Attributes:
        ...
        equList (list of :class:`~MarabouRepo.maraboupy.MarabouUtils.Equation`): Network equations
    ...
    def addEquation(self, x):
        ...
        Args:
            x (:class:`~MarabouRepo.maraboupy.MarabouUtils.Equation`): New equation to add
        """
        self.equList += [x]
    ...
    def solve(self, filename="", verbose=True, options=None):
        ...
        Args:
            ...
            options (:class:`~MarabouRepo.maraboupy.MarabouCore.Options`): Object for specifying Marabou options, defaults to None

        Returns:
            (tuple): tuple containing:
                - exitCode (str): A string representing the exit code (sat/unsat/TIMEOUT/ERROR/UNKNOWN/QUIT_REQUESTED).
                - vals (Dict[int, float]): Empty dictionary if UNSAT, otherwise a dictionary of SATisfying values for variables
                - stats (:class:`~MarabouRepo.maraboupy.MarabouCore.Statistics`): A Statistics object to how Marabou performed
        """
